            ...
            <div class="table-header" style="margin-top: 20px">
               Images
				...
				<div class="action-buttons-flat-view sticky-buttons-bg-color-grey">
				   <a class="addNewModel btn btn-success" onClick="window.location=\'add_new_image.php\';"><i class="fa fa-plus"></i> Add Image</a>
				</div>
...
bootbox.confirm({
	...
	animate: true,
    message: "<span class='alert-body'>Are you sure to delete the image?</span>",
    buttons: {
		...
		if (result==true){
			...
			$.ajax({
				...
				success:function(msg){
					console.log(msg);
					window.location.assign("images.php");
				}
...
//				"file_file_name='"+data[user].file_file_name+"' onclick='editPlaylist(this)' value='Edit'  /> "+
				...
				"playlist_playlist_id='"+data[user].playlist_playlist_id+"' file_file_path="+data[user].file_file_path+" file_file_id="+data[user].file_file_id+" onclick='delete_image(this)' value='Remove'  /> "+
