...
<html>
   <head>
      ...
      <!-- Color Picker -->
      <link rel="stylesheet" href="../dist/css/spectrum.css">
               ...
               <ul class="sidebar-menu" data-widget="tree">
                  ...
                  <li class="treeview menu-open">
                     ...
                     <ul class="treeview-menu" style="display: block;">
                        ...
                        <li><a href="/main/device_groups.php"><i class="fa fa-tv"></i>Device Groups</a></li>
                        <li><a href="/main/all_playlists.php"><i class="fa fa-play"></i>Playlist</a></li>
                        <li><a href="/main/all_layouts.php"><i class="fa fa-th-large"></i>Layouts</a></li>
                        <li class="treeview">
